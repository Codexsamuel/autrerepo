...
import { Star, Users, TrendingUp, Zap, Shield, Brain, Rocket, Target } from "lucide-react";
import Link from 'next/link';

// Agents IA Ultra-Avancés
export const ultraAdvancedAgents = [
  {
    id: 'sentinel-zero',
    name: 'Sentinel Zero',
...
export default function UltraAdvancedAgents() {
  return (
    <section className="py-20 px-4 bg-gradient-to-r from-purple-900 via-red-900 to-black">
        ...
        <div className="text-center mt-12">
          <Link href="/nova-ia/ultra-advanced">
            <Button size="lg" className="bg-gradient-to-r from-purple-600 to-red-600 hover:from-purple-700 hover:to-red-700 text-white text-lg px-8 py-4 rounded-full shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105">
              ...
              Explorer Tous les Agents Ultra-Avancés

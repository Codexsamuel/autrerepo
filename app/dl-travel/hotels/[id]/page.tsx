        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
              ...
              <div className="p-4">
                <div className="grid grid-cols-5 gap-2">
                  {hotel.images.map((image, index) => (
                    <button
                      key={index}
                      className="h-16 rounded-lg overflow-hidden hover:ring-2 hover:ring-blue-500 transition-all"
                    >
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                {hotel.reviewDetails.map(review => (
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-8">
              ...
              <form action="/dl-travel/reservation" method="POST" className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="font-medium">{hotel.rooms[0].price}€</span>
                  </div>
                  <div className="flex justify-between items-center mb-2">
                  ...
                  <div className="border-t border-gray-300 pt-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-lg text-blue-600">{hotel.rooms[0].price}€</span>
                    </div>
                  </div>
                </div>

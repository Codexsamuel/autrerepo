  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats(prev => ({
        ...
        policies: prev.policies + Math.floor(Math.random() * 50) - 25,
        claims: prev.claims + Math.floor(Math.random() * 10) - 5,
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-lg">Solutions d'assurance innovantes</p>
      </div>
          ...
          <Card key={key} className="transform transition-all duration-300 hover:scale-105 hover:shadow-xl border-none bg-white/80 backdrop-blur-sm">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <div className="p-2 bg-indigo-100 rounded-full">
                ...
                {key === 'policies' && <FileText className="h-4 w-4 text-blue-600" />}
                {key === 'claims' && <Heart className="h-4 w-4 text-yellow-600" />}
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Assurances Vie</h3>
                  <p className="text-sm text-gray-600">Protection et épargne</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Assurances Habitation</h3>
                  <p className="text-sm text-gray-600">Protection de votre logement</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Santé</h3>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Prévoyance</h3>
                  <p className="text-sm text-gray-600">Protection contre les risques</p>
                </div>
              </div>
            </div>
          </CardContent>

...
import { 
  ...
  FileToutiao,
  FileDouyin,
  FileTikTok as TikTokIcon,
  FileKwai,
  FileKuaishou,
  FileBilibili,
  FileAcFun,
  FileNiconico,
  FileYoutube as YouTubeIcon,
  FileDailymotion,
  FileVimeo,
  FileDailymotion as DailymotionIcon,
  FileVimeo as VimeoIcon,
  FileTwitch as TwitchIcon,
  FileMixer,
  FileCaffeine,
  FileDLive,
  FileTrovo,
  ...
  FileValorant,
  FileLeagueOfLegends,
  FileTeamfightTactics,
  FileLegendsOfRuneterra,
  FileWildRift,
  FileProjectL,
  FileProjectF,
  FileProjectA,
  FileProjectV,
  FileProjectL as ProjectLIcon,
  FileProjectF as ProjectFIcon,
  FileProjectA as ProjectAIcon,
  FileProjectV as ProjectVIcon
} from 'lucide-react';

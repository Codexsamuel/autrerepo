...
export default function WhatsAppButton() {
  ...
  const handleSendMessage = () => {
    setIsSending(true);
    const phoneNumber = '00237694341586';
    ...
    <div>
      ...
      {!isVisible && (
        <button
          ...
          className="fixed bottom-6 left-6 z-50 bg-gradient-to-r from-gray-600 to-gray-700 text-white p-3 rounded-full shadow-2xl hover:shadow-gray-500/30 transition-all duration-300 hover:scale-110 group border-2 border-gray-400/30"
          aria-label="Activer le chat WhatsApp"
        >
